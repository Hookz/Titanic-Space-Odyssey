...
public class Wind {
    ...
    public double accByWind(UltimateSpaceShip s, double kmtosurface){
    ...
    public void calculateForce(UltimateSpaceShip s){
    ...
    public void calculateRelativeWindSpeed(UltimateSpaceShip s){
        relativeWindSpeed = s.getWind()-s.getVelocity().getX();
    }

    //Call this method for the x displacement in METERS
    public double calcDisplacement(UltimateSpaceShip s, double kmtosurface){
    ...
    public double calcTilt(UltimateSpaceShip s, double kmToSurface){
