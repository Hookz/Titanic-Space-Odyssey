...
//        spaceShip.setMass(5000);
        ...
        while(spaceShip.getCoordinates().getY() > 0.0) {
            ...
            double newVY = (spaceShip.getCoordinates().getY() + yDisplacement(spaceShip.getCoordinates().getY(), TIME_STEP)) / freeFall;
            ...
            spaceShip.getCoordinates().setY(yDisplacement(spaceShip.getCoordinates().getY(), TIME_STEP));
